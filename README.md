...
## Controls
* **Desktop:** Click and drag the mouse to slice.
* **Mobile / iPad:** Tap and swipe across the touch screen.

## Technical Highlights
* Built using **Unity 6 (WebGL)**.
* Native mobile browser support with zero plugins required.
* Dynamic resolution scaling using a balanced Canvas Scaler configuration.
